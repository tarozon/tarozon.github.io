...
from tarozon_core.compose import compose_spread_image
...
if click and isinstance(click, dict) and "x" in click and "y" in click and "width" in click and "height" in click:
...
# Keep URL state in sync (refresh-safe)
_set_query_state(_encode_state(st.session_state.draw_state))